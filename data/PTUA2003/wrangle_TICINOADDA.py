...
laureg1 = pd.read_csv('data/PTUA2003/original/ticiadd/LAU_REG_1_CAP_prov_MI.csv')

laureg2 = pd.read_csv('data/PTUA2003/original/ticiadd/LAU_REG_2_TicinoAdda_settore.csv')
...
laureg3 = pd.read_csv('data/PTUA2003/original/ticiadd/LAU_REG_3_cap.csv')
print(f"{sum(laureg3['codice'].isin(laureg1['CODICE']))} piezometri presenti su {len(laureg3.index)}")
#tutti i piezometri sono presenti

laureg4 = pd.read_csv('data/PTUA2003/original/ticiadd/LAU_REG_4_mivecchi.csv')
...
#ts2 contains shorter series which creates issues in the merging later on
#I decided to only keep the series present in the first file, laureg1, and just
#add eventual metadata information to the first metadata file
